      ...
      <section className="pt-20 pb-16 px-4 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto text-center max-w-4xl">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Trial Your Next Hire.{" "}
            <span className="text-orange-500">Without the Risk.</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            CTX-EOR handles payroll, taxes, compliance, and onboarding so you can test
            real performance before committing to a full hire. Built exclusively for
            US employers who believe hiring shouldn't feel like a gamble.
          </p>
