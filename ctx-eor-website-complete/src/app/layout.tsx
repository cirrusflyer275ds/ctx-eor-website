              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-400">
                    <li><a href="#" className="hover:text-white">Try-Before-Hire EOR</a></li>
                    <li><a href="#" className="hover:text-white">Job Object Technology</a></li>
                    <li><a href="#" className="hover:text-white">Video Screening</a></li>
                    <li><a href="#" className="hover:text-white">Compliance Management</a></li>
                  </ul>
                </div>
                <div>
